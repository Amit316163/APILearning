...
//		
//		int amout=js.get("dashboard.purchaseAmount");
//		
//		System.out.println(amout);
//		Assert.assertEquals(8000, amout);
		
		//Jayway
		
		int purAmt=JsonPath.read(response.asString(), "$.dashboard.purchaseAmount");
		
		//Object ok=JsonPath.read(response, "$.dashboard.purchaseAmount");
